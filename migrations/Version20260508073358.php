 ...
 */
final class Version20260508073358 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comment DROP updated_at, CHANGE status status VARCHAR(255) NOT NULL');
        ...
        $this->addSql('ALTER TABLE post DROP updated_at, CHANGE status status VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comment ADD updated_at DATETIME DEFAULT NULL, CHANGE status status VARCHAR(50) NOT NULL');
        ...
        $this->addSql('ALTER TABLE post ADD updated_at DATETIME DEFAULT NULL, CHANGE status status VARCHAR(50) NOT NULL');
